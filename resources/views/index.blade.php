  ...
  <head>
    ...
    --color-grey: #f5f6f8;
        ...
        .register-bg {
            ...
            background-image: url("https://i.pinimg.com/originals/cf/64/59/cf6459cb006a54ea390a63e7880eb0ae.jpg");
           ...
           <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container align-self-center p-6">
                    ...
                    <div class="form-group">
                        ...
                        {{-- BOTTON Twitch   --}}
                        <button class="btn btn-outline-dark d-inline-block text-light mb-3 width-100" onclick=" location.href='https://www.facebook.com/profile.php?id=100074506975087' "><i class="icon ion-logo-twitch lead align-middle mr-2"></i> Twitch</button>
